...
completion = client.chat.completions.create(
    ...
    messages=[
        {
            "role": "user",
            "content": "Context : We are trying to determine if a file has been tampered with / displays any signs of suspicious behavior using metadata analysis.\n Here is the file's metadata :" +
                       str(metadata) +
